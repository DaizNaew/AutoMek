			...
			<div class="header clearfix" style="border-bottom:hidden">
				<nav>
					<ul class="nav nav-pills pull-right">
						...
						<li role="presentation" ><a href="registercar.php">Registrer Bil</a></li>
				...
				<h3 class="text-muted" style="align: center;">Velkommen til Automekanikernes Bil booking system</h3>

			</div>
			<div class="søgefelt">
				<label>Søg efter Bil via dato: </label><input id="datepicker" type="text" name="dato" autocomplete="off">
