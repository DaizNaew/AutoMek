	...
	<body>
		<div class="container-fluid" style="width: 85%">
			...
			<div style="overflow-x:auto;">
				...
				<td><p class="text-muted"><?php echo $bilFarve; ?></p></td>
				...
				<h2>Bruges til</h2>
					...
					<form method="GET" action="registerbrug.php" id="brugForm">
					<label>Brug: </label><input type="text" class="input-sm" name="brugNavn" required>
					<input type="hidden" name="IDbil" value="<?php echo $bilID; ?>">
					<input type="submit" class="btn btn-primary" name="submit" value="Registrer brug">
					</form>
				...
				<?php	for($i = 0; $i < count($carbrug); $i++) {	?>

					<tr class="hoverable">

					<td><p class="text-muted"><?php echo $carbrug['Brug'.$i]; ?></p></td>
			...
			<div style="margin: 22px; border-bottom: solid 3px white; "></div>
				<h2>Bestilte reservedele</h2>

					<form method="GET" action="registerspareparts.php" id="reservedelsForm">
					<label>Reservedel: </label><input type="text" class="input-sm" name="reservedelNavn" required>
					<label>Lærer Navn: </label><input type="text" class="input-sm" name="læreNavn">

					<input type="hidden" name="IDbil" value="<?php echo $bilID; ?>">
					<input type="submit" class="btn btn-primary" name="submit" value="Registrer bestilt reservedel">
					</form>

				<br>

			<?php if(count($carspareparts)/2 != 0){

				?>
				<table style="border: solid 1px #ddd; " >
				<tr>

				<td><h3>Reservedel</h3></td>
				<td><h3>Bestilt af</h3></td>

				</tr>

				<?php $arrayLength = count($carspareparts) / 2;
				...
				for($i = 0; $i < $arrayLength; $i++) {
					...
					<td><p class="text-muted"><?php echo $carspareparts['Reservedel'.$i]; ?></p></td>

					<td><p class="text-muted"><?php echo $carspareparts['Lære'.$i]; ?></p></td>
			...
			<div style="margin: 22px; border-bottom: solid 3px white; "></div>
				...
				<div style="margin: 22px; border-bottom: solid 3px white; "></div>
					<h2>Aflever Bilen</h2>
						...
						<form method="GET" action="registerdelivery.php" id="afleverForm">

						<label>Den: </label><input class="datepicker" type="text" name="afleverDato" >
						<label>Lære: </label><input type="text" class="input-sm" name="læreNavn" required>
					...
					<table style="border: solid 1px #ddd; " >
						...
						<tr>
							<td><h3>Bilen afleveret den</h3></td>
							<td><h3>Godkendt af</h3></td>
						</tr>

					<?php
					$arrayLength = count($cardelivered) / 3;
					for($i = 0; $i < $arrayLength; $i++) {	$o = $i+1; ?>

						<tr class="hoverable">

						<td><p class="text-muted"><?php echo $cardelivered['Dato'.$i]; ?></p></td>
						<td><p class="text-muted"><?php echo $cardelivered['Lære'.$i]; ?></p></td>
