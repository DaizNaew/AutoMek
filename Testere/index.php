...
<html>
	...
	<title>Automekaniker Testere Booking</title>
			...
			<div class="header clearfix" style="border-bottom:hidden">
				<nav>
					<ul class="nav nav-pills pull-right">
						...
						<li role="presentation" ><a href="registercar.php">Registrer Tester</a></li>
						...
						<li role="presentation" ><a href="../MotorBooking/index.php">Motor booking</a></li>
					</ul>
				</nav>
				<h3 class="text-muted" style="align: center;">Velkommen til Automekanikernes Testere booking system</h3>

			</div>
			<div class="søgefelt">
				<label>Søg efter Testere via dato: </label><input id="datepicker" type="text" name="dato" autocomplete="off">
